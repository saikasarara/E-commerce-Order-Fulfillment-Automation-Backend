...
System.out.print("\n" + Utils.ANSI_BLUE + "Admin Login Required" +
Utils.ANSI_RESET + "\n");
...
if (next == null) {
System.out.print(Utils.ANSI_PINK + "No PENDING orders." +
Utils.ANSI_RESET + "\n");
} else {
...
System.out.print(Utils.ANSI_PINK + "Invalid." +
Utils.ANSI_RESET + "\n");
}
}
}
private void printMenu() {
System.out.print("\n" + Utils.ANSI_BLUE + "--- Admin Dashboard ---" +
Utils.ANSI_RESET + "\n");
System.out.print(Utils.ANSI_BLUE + "1) View Orders" + Utils.ANSI_RESET
+ "\n");
System.out.print(Utils.ANSI_BLUE + "2) Accept New Order (Order Intake)"
+ Utils.ANSI_RESET + "\n");
System.out.print(Utils.ANSI_BLUE + "3) Process Next PENDING Order" +
Utils.ANSI_RESET + "\n");
System.out.print(Utils.ANSI_BLUE + "4) View Purchase History" +
Utils.ANSI_RESET + "\n");
System.out.print(Utils.ANSI_BLUE + "5) View Stock Report" +
Utils.ANSI_RESET + "\n");
System.out.print(Utils.ANSI_BLUE + "6) Exit" + Utils.ANSI_RESET + "\n");
System.out.print(Utils.ANSI_BLUE + "Choose: " + Utils.ANSI_RESET);
}
...
System.out.print(Utils.ANSI_BLUE + "New Order ID: " + oid +
Utils.ANSI_RESET + "\n");
...
o.paymentMode = pay;
o.status = "PENDING";
// Interactive product selection for order items
System.out.print("\n" + Utils.ANSI_BLUE + "Available Products:" +
Utils.ANSI_RESET + "\n");
...
System.out.print(Utils.ANSI_PINK + "Invalid product selection."
+ Utils.ANSI_RESET + "\n");
continue;
}
...
if (qty <= 0) {
System.out.print(Utils.ANSI_PINK + "Quantity must be positive."
+ Utils.ANSI_RESET + "\n");
continue;
}
...
o.status = "COMPLETED";
log.write(o.orderId, "ORDER_COMPLETE", "OK",
"Invoice=" + inv.invoiceId + " Tracking=" + sh.trackingId);
// Append to purchase history record
try {
FileWriter fw = new FileWriter(dp.path("purchase_history.txt"),
true);
fw.write(o.orderId + "|" + o.paymentMode + "|" + o.status + "|" +
o.totalAmount + "\n");
fw.close();
} catch (Exception e) {
...
System.out.print(Utils.ANSI_PINK + "❌ CANCELLED: " + reason +
Utils.ANSI_RESET + "\n");
}
...
System.out.print("\n" + Utils.ANSI_BLUE + "Stock Report:" +
Utils.ANSI_RESET + "\n");
System.out.print(Utils.ANSI_BLUE + "ProductID | Name | Stock" +
Utils.ANSI_RESET + "\n");
